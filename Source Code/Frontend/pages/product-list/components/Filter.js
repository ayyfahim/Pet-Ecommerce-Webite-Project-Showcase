...
const Filter = ({ categories, setCategories, brands, setBrands, concerns, setConcerns, clearFilter }) => {
  return (
    <div className={style.wrapper}>
      ...
      <FilterObject title={'CONCERN'} filter={concerns} onChange={setConcerns} />
