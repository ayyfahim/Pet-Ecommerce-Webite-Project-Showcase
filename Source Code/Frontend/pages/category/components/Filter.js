...
const Filter = ({
  ...
  return (
    <div className={style.wrapper}>
      ...
      <FilterObject title={'CATEGORIES'} filter={categories} onChange={setCategories} category_id={category_id} />
      <FilterObject title={'BRAND'} filter={brands} onChange={setBrands} />
      <FilterObject title={'CONCERNS'} filter={concerns} onChange={setConcerns} />
