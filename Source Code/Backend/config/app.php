...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'VitalPawz'),
    'email' => env('APP_EMAIL', 'support@vitalpawz.com'),
    ...
    */
    ...
    'frontend_edit_url' => env('FRONTEND_URL', 'https://stage.vitalpawz.com/account/edit'),
    'frontend_url' => env('FRONTEND_URL', 'https://stage.vitalpawz.com'),
    /*
    |--------------------------------------------------------------------------
