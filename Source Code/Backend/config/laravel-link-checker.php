...
return [
     ...
     */
    'default_reporter' => env('APP_DEBUG')
        ? Spatie\LinkChecker\Reporters\LogBrokenLinks::class
        : Spatie\LinkChecker\Reporters\MailBrokenLinks::class,
    ...
    'reporters' => [
        'mail' => [
             ...
             */
            'to_address' => env('MAIL_FROM_ADDRESS'),
