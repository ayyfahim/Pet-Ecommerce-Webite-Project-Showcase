...
return [
    ...
    "directories_have_correct_permissions" => [
        "message" => "The following directories are not writable:\n:directories",
    ...
    "example_environment_variables_are_set" => [
        "message" => "These environment variables are missing in your .env file, but are defined in your .env.example:\n:variables",
        "name" => "The example environment variables are set"
    ],
    "example_environment_variables_are_up_to_date" => [
        "message" => "These environment variables are defined in your .env file, but are missing in your .env.example:\n:variables",
    ...
    "locales_are_installed" => [
        "message" => [
            ...
            "missing_locales" => "The following locales are missing:\n:locales",
    ...
    "php_extensions_are_disabled" => [
        "message" => "The following extensions are still enabled:\n:extensions",
        "name" => "Unwanted PHP extensions are disabled"
    ],
    "php_extensions_are_installed" => [
        "message" => "The following extensions are missing:\n:extensions",
    ...
    "supervisor_programs_are_running" => [
        "message" => [
            "cannot_run_on_windows" => "This check cannot be run on Windows.",
            "not_running_programs" => "The following programs are not running or require a restart:\n:programs",
