...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="information" aria-labelledby="information-tab" role="tabpanel">
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select data-minimum-results-for-search="Infinity" class="form-control text-capitalize select2"
                        ...
                        @foreach($status as $statusItem)
                            <option @if(isset($article) && $article->status_id == $statusItem->id) selected
            ...
            <div class="col-12">
                <label>Author</label>
                <select class="form-control select2" name="author_id" data-width="100%">
                    <option value=""></option>
                    @foreach($authors as $author)
                        <option @if(isset($article) && $article->author_id == $author->id) selected
